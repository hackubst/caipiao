                                ...
                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left pad0 w{{v.kj}}" >
                                    <span v-if="v.kj==1">
                                        ...
                                        <template v-for="(index, sv) in v.kjjg">
                                        	<span v-if="index==5">
                                        		<div class="result_num" style="width:25px;height:25px;line-height:25px;">{{sv}}</div>
                                        	</span>
                                        </template>

                                        <template v-for="(index, sv) in v.kjjg2">
                                        	<span v-if="sv<7">
                                        		<img src="<?php echo isset($skin)?$skin:"";?>img/ssc/ds_{{sv}}.png">
                                        	</span>
                                        </template>
        ...
        <div class="row">
            ...
            <div class="small-show">
                <div  id="press">
                    ...
                    <div class="row small-btn small-36" >
                        <p><a class="btn btn-danger btn-block small-red"><span id="clickhtml">号码四</span> </a></p>
                    ...
                    <div class="row small-btn small-36" >
                        <p><a class="btn btn-danger btn-block small-red"><span id="clickhtml">号码五</span> </a></p>
                    ...
                    <div class="row small-btn small-36" >
                        <p><a class="btn btn-danger btn-block small-red"><span id="clickhtml">前三</span> </a></p>
                    ...
                    <div class="row small-btn small-36" >
                        <p><a class="btn btn-danger btn-block small-red"><span id="clickhtml">中三</span> </a></p>
                    ...
                    <div class="row small-btn small-36" >
                        <p><a class="btn btn-danger btn-block small-red"><span id="clickhtml">后三</span> </a></p>
